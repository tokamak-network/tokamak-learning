          ...
          return (
            ...
            >
              <Link
                ...
                className="group block border border-[var(--color-border)] rounded-lg p-6 hover:border-[var(--color-accent)] transition-all bg-[var(--color-surface)] hover:-translate-y-0.5 hover:shadow-[var(--shadow-card)]"
              >
